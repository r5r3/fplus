...
public class TreeVisitor extends fplusBaseVisitor<Object> {
    ...
    public Object visitDynamicCast(fplusParser.DynamicCastContext ctx) {       
        ...
        info.setExpansion(ctx, String.format("%s(%s, %d, %d)", functionName, ctx.content().getText(), ctx.getStart().getLine(), ctx.getStart().getCharPositionInLine()));
